      ...
      <div className="container mt-4">
        <nav className="navbar navbar-expand-lg navbar-dark bg-primary mb-4 rounded">
          <Link className="navbar-brand d-flex align-items-center" to="/">
            ...
            <span className="text-white">OctoFit Tracker</span>
          </Link>
        ...
        <Routes>
          ...
          <Route path="/" element={<div className="card p-4"><h2 className="card-title text-center">Welcome to <span className="text-primary">OctoFit Tracker</span>!</h2><p className="card-text text-center">Track your fitness, join teams, and compete on the leaderboard.</p></div>} />
        </Routes>
      </div>
    </Router>
  );
